...
datos = pd.read_csv("persons_medical_checks.csv", sep="|")

datos.columns = datos.columns.str.replace("|", "_")
sql_datos_cabecera="insert into persons_medical_check VALUES ("
...
with open("persons_medical_checks.sql", "w", encoding="UTF-8") as f:
    f.write(SQL_FINAL)